    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.documentos.usuarios') }}" class="btn btn-secondary">
                ...
                <div class="card {{ $doc ? 'border-success' : ($pendiente ? 'border-warning' : 'border-secondary') }}">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            @if($doc)
                                <a href="{{ route('admin.documentos.show', $doc->id) }}" class="btn btn-sm btn-primary">
                                    <i class="fas fa-eye"></i> Ver
                                </a>
                            @elseif($pendiente)
                                <a href="{{ route('admin.documentos.show', $pendiente->id) }}" class="btn btn-sm btn-warning">
