        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('admin.documentos.usuario', $documento->user_id) }}" class="btn btn-sm btn-outline-primary w-100">
                            <i class="fas fa-folder-open me-1"></i> Ver Todos sus Documentos
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($documento->imagen_frente)
                                ...
                                <a href="{{ $urlFrente }}" target="_blank">
                                    <img src="{{ $urlFrente }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($documento->imagen_reverso)
                                ...
                                <a href="{{ $urlReverso }}" target="_blank">
                                    <img src="{{ $urlReverso }}" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="border border-success rounded p-4 h-100">
                                ...
                                <form action="{{ route('admin.documentos.aprobar', $documento->id) }}" method="POST" id="formAprobar">
                                    @csrf
                                    @method('PUT')
...
function confirmarRechazo() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = '{{ route('admin.documentos.rechazar', $documento->id) }}';
