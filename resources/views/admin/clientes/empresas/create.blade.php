...
<div class="min-h-screen bg-gray-100 flex">
    ...
    <div class="flex-1 lg:mr-64">
        ...
        <div class="container mx-auto px-4 py-6 max-w-4xl">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Crear empresa (cliente)</h1>
                ...
                <form action="{{ route('admin.clientes.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="md:col-span-2">
                            ...
                            <select id="modalidad_id" name="modalidad_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('modalidad_id') border-red-500 @enderror">
                                <option value="">Seleccione modalidad</option>
                                @foreach($modalidades ?? [] as $m)
                                    <option value="{{ $m->id }}" {{ old('modalidad_id') == $m->id ? 'selected' : '' }}>{{ $m->nombre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" id="codigo" name="codigo" value="{{ old('codigo') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('codigo') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" id="rut" name="rut" value="{{ old('rut') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('rut') border-red-500 @enderror">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="razon_social" name="razon_social" value="{{ old('razon_social') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('razon_social') border-red-500 @enderror">
                            @error('razon_social')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                        </div>
                        <div class="md:col-span-2">
                            <label for="direccion" class="block text-sm font-medium text-gray-700 mb-1">Dirección</label>
                            <input type="text" id="direccion" name="direccion" value="{{ old('direccion') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('direccion') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" id="ciudad" name="ciudad" value="{{ old('ciudad') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label for="region" class="block text-sm font-medium text-gray-700 mb-1">Región</label>
                            <input type="text" id="region" name="region" value="{{ old('region') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                        <a href="{{ route('admin.clientes.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg">Cancelar</a>
                        <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">Guardar empresa</button>
                    </div>
                </form>
            </div>
        </div>
