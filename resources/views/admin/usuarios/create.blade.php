                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="perfil" name="perfil" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 @error('perfil') border-red-500 @enderror">
                                <option value="4" {{ old('perfil', '4') == 4 ? 'selected' : '' }}>Usuario</option>
                                <option value="3" {{ old('perfil') == 3 ? 'selected' : '' }}>Supervisor-Usuario</option>
                                <option value="2" {{ old('perfil') == 2 ? 'selected' : '' }}>Supervisor</option>
