                ...
                <form action="{{ route('admin.usuarios.update', $usuario) }}" method="POST">
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="telefono" name="telefono" value="{{ old('telefono', $usuario->telefono) }}" placeholder="Ej. +56912345678"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 @error('telefono') border-red-500 @enderror">
