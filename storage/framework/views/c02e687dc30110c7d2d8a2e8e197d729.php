    ...
    <div class="flex-grow-1 overflow-auto py-2 px-2">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs('usuario.reportes.*') ? 'show' : ''); ?>" id="mobile-mis-reportes">
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs('usuario.documentos.*') ? 'show' : ''); ?>" id="mobile-mis-documentos">
                    <ul class="nav flex-column ms-4 ps-2 border-start border-secondary">
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs(['admin.reportes-especiales.*', 'admin.rondas.reporte', 'admin.reportes-diarios', 'admin.reporte-sucursal']) ? 'show' : ''); ?>" id="mobile-reportes-admin">
                    <ul class="nav flex-column ms-4 ps-2 border-start border-secondary">
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs(['admin.usuarios.*', 'admin.documentos.*', 'admin.novedades.*', 'supervisor.documentos.*']) ? 'show' : ''); ?>" id="mobile-usuarios-docs">
                    <ul class="nav flex-column ms-4 ps-2 border-start border-secondary">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->esAdministrador()): ?>
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs(['admin.dispositivos.*', 'admin.ubicaciones.*', 'admin.sectores.*', 'admin.rondas.*']) && !request()->routeIs('admin.rondas.reporte') ? 'show' : ''); ?>" id="mobile-gestion">
                    <ul class="nav flex-column ms-4 ps-2 border-start border-secondary">
...
<?php /**PATH C:\Users\UrraServer\Documents\Docker\server-apache\web-seguridad\resources\views/components/usuario/mobile-menu.blade.php ENDPATH**/ ?>