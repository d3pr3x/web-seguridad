    ...
    <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm border-0">
            <div class="card-body p-5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['ubicacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <i class="fas fa-map-marker-alt me-2"></i><?php echo e($message); ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" 
                                   class="form-control rut-input <?php $__errorArgs = ['rut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<script src="<?php echo e(asset('js/browser-fingerprint.js')); ?>"></script>
<script>
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        try {
            const response = await fetch('<?php echo e(route('api.verificar-dispositivo')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\UrraServer\Documents\Docker\server-apache\web-seguridad\resources\views/auth/login.blade.php ENDPATH**/ ?>