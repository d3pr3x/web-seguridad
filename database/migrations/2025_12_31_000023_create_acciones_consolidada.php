...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('acciones', function (Blueprint $table) {
            ...
            $table->string('tipo_hecho', 50)->nullable()->comment('incidente, observacion, informacion, delito, accidente');
            $table->string('importancia', 20)->nullable()->comment('importante, cotidiana, critica');
            $table->date('dia');
            $table->time('hora');
